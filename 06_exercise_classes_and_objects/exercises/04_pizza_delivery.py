class PizzaDelivery:
    ...
    def add_extra(self, ingredient, quantity, price_per_quantity):
        ...
        self.ingredients = self.ingredients.get(ingredient, 0) + quantity
    ...
    def make_order(self):
        ...
        return f"You've ordered pizza {self.name} prepared with {ingredient: quantity} and the price will be {self.price}lv."
